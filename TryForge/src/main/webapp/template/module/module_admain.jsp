			...
			<div class="navbar-brand-wrapper d-flex justify-content-center"
				...
				<div
					...
					<a class="navbar-brand brand-logo-mini" href="index.jsp">
						<img src="${path}/template/images/try_logo.jpg" alt="logo"
							style="width: 100%;" />
					</a>
		...
		<nav class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0"
			...
			<div class="navbar-links-wrapper d-flex align-items-stretch">
				<div class="nav-link" style="border-right: none; flex-grow: 0.1;">
					<a onclick="location.href='${path}/adMain.do'"><i
						class="mdi mdi-desktop-mac"></i></a>
				</div>
				<div class="nav-link" style="border-right: none; flex-grow: 0.1;">
			...
			<nav class="sidebar sidebar-offcanvas" id="sidebar">
				<ul class="nav">
					<li class="nav-item"><a class="nav-link"> <i
							class="mdi mdi-airplay" style="width: 20px; height: 20px;"></i> <span
							class="menu-title">프로젝트관리</span> <!-- <div class="badge badge-danger">new</div> -->
					</a></li>

					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse"
						onclick="location.href='${path}/reqPJList.do'"
					...
					<li class="nav-item"><a class="nav-link"
						data-toggle="collapse" aria-expanded="false" aria-controls="icons"
						onclick="location.href='${path}/noticeList.do'"> <i
							class="mdi mdi-tooltip-text" style="width: 20px; height: 20px;"></i>
							<span class="menu-title">공지사항관리</span> <!-- <i class="menu-arrow"></i> -->
